...
class NicknamesAdapter(val context: Context, val viewModel: MainViewModel,val lifecycleOwner: LifecycleOwner) : RecyclerView.Adapter<NicknamesViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): NicknamesViewHolder {
        return NicknamesViewHolder(itemView = LayoutInflater.from(viewGroup.context).inflate(
...
class NicknamesViewHolder(itemView: View, val context: Context, val viewModel: MainViewModel,val lifecycleOwner: LifecycleOwner) : RecyclerView.ViewHolder(
    itemView){
